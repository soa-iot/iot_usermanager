...
layui.define("view", function(e) {
	var a = layui.jquery, i = layui.laytpl, t = layui.element, l = layui.setter, n = layui.view, s = layui
			.device(), r = a(window), o = a("body"), u = a("#" + l.container), d = "layui-show", c = "layui-hide", y = "layui-this", f = "layui-disabled", h = "#LAY_app_body", m = "LAY_app_flexible", p = "layadmin-layout-tabs", v = "layadmin-side-spread-sm", b = "layadmin-tabsbody-item", g = "layui-icon-shrink-right", x = "layui-icon-spread-left", C = "layadmin-side-shrink", k = "LAY-system-side-menu", F = {
		v : "1.0.0 std",
		req : n.req,
		sendAuthCode : function(e) {
			...
			var i, t = e.seconds, l = a(e.elem), n = function(a) {
				t--, t < 0
						...
						: l.addClass(f).html(t + "秒后重获"), a
						|| (i = setInterval(function() {
									n(!0)
								}, 1e3))
			};
			e.elemPhone = a(e.elemPhone), e.elemVercode = a(e.elemVercode), l
					.on("click", function() {
		...
		sideFlexible : function(e) {
			...
			"spread" === e ? (t.removeClass(x).addClass(g), n < 2 ? i
					.addClass(v) : i.removeClass(v), i.removeClass(C)) : (t
					.removeClass(g).addClass(x), n < 2 ? i.removeClass(C) : i
					.addClass(C), i.removeClass(v)), layui.event.call(this,
					l.MOD_NAME, "side({*})", {
						status : e
					})
		},
		...
		theme : function(e) {
			var t = (l.theme, layui.data(l.tableName)), n = "LAY_layadmin_theme", s = document
					.createElement("style"), r = i([
					".layui-side-menu,",
					...
					"{{# } }}"].join("")).render(e = a.extend({}, t.theme, e)), u = document
					.getElementById(n);
			"styleSheet" in s
					? (s.setAttribute("type", "text/css"), s.styleSheet.cssText = r)
					: s.innerHTML = r, s.id = n, u && o[0].removeChild(u), o[0]
					.appendChild(s), o.attr("layadmin-themealias",
					e.color.alias), t.theme = t.theme || {}, layui.each(e,
					function(e, a) {
						t.theme[e] = a
		...
		tabsBodyChange : function(e, a) {
			a = a || {}, F.tabsBody(e).addClass(d).siblings().removeClass(d), P
					.rollPage("auto", e), layui.event.call(this, l.MOD_NAME,
					"tabsPage({*})", {
						url : a.url,
						text : a.text
					})
		...
		resize : function(e) {
			...
			r.off("resize", F.resizeFn[i]), e(), F.resizeFn[i] = e, r.on(
					"resize", F.resizeFn[i])
		},
		resizeFn : {},
		runResize : function() {
		...
		closeThisTabs : function() {
			F.tabsPage.index
					&& a(z).eq(F.tabsPage.index).find(".layui-tab-close")
							.trigger("click")
		}
	}, P = F.events = {
		flexible : function(e) {
		...
		serach : function(e) {
			e.off("keypress").on("keypress", function(a) {
				if (this.value.replace(/\s/g, "") && 13 === a.keyCode) {
					var i = e.attr("lay-action"), t = e.attr("lay-text")
							|| "搜索";
					i += this.value, t = t + ' <span style="color: #FF5722;">'
							+ F.escape(this.value) + "</span>", layui.index
							.openTabsPage(i, t), P.serach.keys
							|| (P.serach.keys = {}), P.serach.keys[F.tabsPage.index] = this.value, this.value === P.serach.keys[F.tabsPage.index]
							&& P.refresh(e), this.value = ""
				}
			})
		},
		message : function(e) {
		...
		note : function(e) {
			...
			P.note.index = F.popup({
				...
				success : function(e, a) {
					var t = e.find("textarea"), n = void 0 === i
		...
		fullscreen : function(e) {
			var a = "layui-icon-screen-full", i = "layui-icon-screen-restore", t = e
					.children("i");
			if (t.hasClass(a)) {
				var l = document.body;
				l.webkitRequestFullScreen
						...
						: l.mozRequestFullScreen
								? l.mozRequestFullScreen()
								: l.requestFullScreen && l.requestFullscreen(), t
						.addClass(i).removeClass(a)
			} else {
				var l = document;
		...
		setTheme : function(e) {
			...
			e.hasClass(y)
					|| (e.addClass(y).siblings(".layui-this").removeClass(y), F
							.initTheme(a))
		},
		rollPage : function(e, i) {
			var t = a("#LAY_app_tabsheader"), l = t.children("li"), n = (t
					.prop("scrollWidth"), t.outerWidth()), s = parseFloat(t
					.css("left"));
			if ("left" === e) {
				if (!s && s <= 0)
					return;
		...
		closeOtherTabs : function(e) {
			...
			"all" === e ? (a(z + ":gt(0)").remove(), a(h).find("." + b
					+ ":gt(0)").remove(), a(z).eq(0).trigger("click")) : (a(z)
					.each(function(e, t) {
						e
								&& e != F.tabsPage.index
		...
		im : function() {
			F.popup({
						...
						offset : "lb",
						success : function() {
							layui.view(this.id).render("layim/demo").then(
									function() {
										layui.use("im")
									})
						}
	...
	!function() {
		...
		e.theme ? F.theme(e.theme) : l.theme
				&& F.initTheme(l.theme.initColorIndex), "pageTabs" in layui.setter
				|| (layui.setter.pageTabs = !0), l.pageTabs
				|| (a("#LAY_app_tabs").addClass(c), u
						.addClass("layadmin-tabspage-none")), s.ie
				&& s.ie < 10
				&& n
						.error(
								"IE"
		...
		var i = e.url, t = function(e) {
			...
			e.each(function(e, l) {
				var s = a(l), r = t(s), o = r.list.children("dd"), u = i === r.a
						.attr("lay-href");
				if (o.each(function(e, l) {
					var s = a(l), r = t(s), o = r.list.children("dd"), u = i === r.a
							.attr("lay-href");
					if (o.each(function(e, l) {
								var s = a(l), r = t(s), o = i === r.a
										.attr("lay-href");
								if (o) {
									var u = r.list[0] ? n : y;
									return s.addClass(u).siblings()
											.removeClass(u), !1
								}
							}), u) {
						var d = r.list[0] ? n : y;
		...
		l.find("." + y).removeClass(y), F.screen() < 2 && F.sideFlexible(), s(l
				.children("li"))
	}), t.on("nav(layadmin-system-side-menu)", function(e) {
		e.siblings(".layui-nav-child")[0] && u.hasClass(C)
				&& (F.sideFlexible("spread"), layer.close(e.data("index"))), F.tabsPage.type = "nav"
	...
	o.on("click", z, function() {
		...
		if (!e.parent().hasClass("layui-nav-item") || u.hasClass(C)) {
			var i = e.attr("lay-tips"), t = e.attr("lay-offset"), l = e
					.attr("lay-direction"), n = layer.tips(i, this, {
						tips : l || 1,
						time : -1,
						success : function(e, a) {
