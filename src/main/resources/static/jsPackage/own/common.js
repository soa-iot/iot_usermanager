/*
 * 一、js目录 1.layui验证扩展方法 2.生成html方法 3.js获取当前时间 4.js获取当前日期
 */
...
/*
 * js生成html tagHtml--输出全部的html代码 pageName--输出页面默认名字
 */
...
/*
 * 获取当前时间 seperator1日期分割符号 seperator2时间分割符号
 */
var getNowTime = function(seperator1, seperator2) {
	var nowDate = new Date();
	return nowDate.getFullYear() + seperator1 + (nowDate.getMonth() + 1)
			+ seperator1 + nowDate.getDate() + " " + nowDate.getHours()
			+ seperator2 + nowDate.getMinutes() + seperator2
			+ nowDate.getSeconds();
}

/*
 * 获取当前日期 seperator1日期分割符号
 */
