 ...
 * 全局变量
 */
var saveUrl = ipPort + '/iot_usermanager/user',
	deleteUrl = ipPort + '/iot_usermanager/user/organ',
	putUrl = ipPort + '/iot_usermanager/userInfo/state',
	registerUrl = ipPort + '/iot_usermanager/register/list',
	saveUserInfoUrl = ipPort + '/iot_usermanager/user/userInfo',
	modifyRegStateUrl = ipPort + '/iot_usermanager/register/state';
...
layui.config({
    ...
    ptable=treeGrid.render({
        id:tableId
        ,elem: '#'+tableId
        ,url:ipPort +'/iot_usermanager/user/list'
        ,cellMinWidth: 100
