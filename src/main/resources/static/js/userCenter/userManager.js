	        ...
	        success: function( layero, index ){
	        	...
	        	layui.config({
	        	    ...
	        	    ptable=treeGrid.render({
	        	        ...
	        	        ,heightRemove:[".dHead",50]//不计算的高度,表格设定的是固定高度，此项不生效
	        	       ,height:845
	        	        ...
	        	        ,cols: [[
	        	            {type:'numbers'}
	        	            ,{type:'radio'}
	        	            ,{field:'name', width:'30%', title: '人员组织名称',edit:'text'}
	        	            ,{field:'usernum',width:'30%', title: 'id',edit:'text',hide:true}
	        	            ,{field:'parent_id', title: 'pid',hide:true}
	        	        ]]
